...
# # Set Google credentials (path to your JSON file)
# os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "dialogflow-key.json"

# PROJECT_ID = "bankingfinancebot-lfrs"  # Replace with your Dialogflow project ID
...
# # Streamlit UI
# st.set_page_config(page_title="Banking & Finance FAQ Bot", page_icon="💬")
# st.title("💬 Banking & Finance FAQ Chatbot")
# st.markdown("Ask me anything about banking services, accounts, loans, and more!")
...
# if st.button("Send"):
#     if user_input.strip():
#         bot_response = detect_intent_text(PROJECT_ID, SESSION_ID, user_input)
...
#     if role == "You":
#         st.markdown(f"""
#         <div style="background-color:#D6EAF8; padding:10px; border-radius:10px; margin:5px; text-align:right;">
#         <b>🧑‍💼 You:</b> {text}
#         </div>
#         """, unsafe_allow_html=True)
#     else:
#         st.markdown(f"""
#         <div style="background-color:#E8F6F3; padding:10px; border-radius:10px; margin:5px; text-align:left;">
#         <b>🤖 Bot:</b> {text}
#         </div>
#         """, unsafe_allow_html=True)

# # Footer
# st.markdown("<hr><p style='text-align:center; color:grey;'>© 2025 Banking & Finance FAQ Bot | Built with Dialogflow ES + Streamlit</p>", unsafe_allow_html=True)
